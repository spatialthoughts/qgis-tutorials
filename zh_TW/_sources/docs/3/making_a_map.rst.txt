...
Download the `Natural Earth Quickstart Kit <https://naciscdn.org/naturalearth/packages/Natural_Earth_quick_start.zip>`_. If the download link doesn't work, get it directly from `Natural Earth Downloads <https://www.naturalearthdata.com/downloads/>`_ page.
