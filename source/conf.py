...
latex_documents = [
  ('index', 'QGISTutorials.tex', u'QGIS Tutorials Documentation',
   u'Ujaval Gandhi', 'manual'),
]
...
man_pages = [
    ('index', 'qgistutorials', u'QGIS Tutorials Documentation',
     [u'Ujaval Gandhi'], 1)
]
...
texinfo_documents = [
  ('index', 'QGISTutorials', u'QGIS Tutorials Documentation',
   u'Ujaval Gandhi', 'QGISTutorials', 'One line description of project.',
   'Miscellaneous'),
]
...
epub_title = u'QGIS Tutorials'
epub_author = u'Ujaval Gandhi'
epub_publisher = u'Ujaval Gandhi'
epub_copyright = u'2013, Ujaval Gandhi'
