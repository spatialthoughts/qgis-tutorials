...
tutorials['en'] = [
        ...
        ('working_with_projections', 'Working with Projections'),
        ...
        ('processing_graphical_modeler', 'Automating Complex Workflows using Processing Modeler'),
        ('automating_map_creation', 'Automating Map Creation with Print Composer Atlas'),
        ...
        ('custom_python_functions', 'Using Custom Python Expression Functions'),
        ('processing_python_scripts', 'Writing Python Scripts for Processing Framework'),
