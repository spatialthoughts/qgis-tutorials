...
.. raw:: html
   ...
   <p>[ Download PDF
   <a class="reference external" href="../pdf/working_with_attributes_a4.pdf" onClick="ga('send', 'event', 'PDF Download', 'Working_with_attributes_a4');" target="_blank">A4</a>

   <a class="reference external" href="../pdf/working_with_attributes_letter.pdf" onClick="ga('send', 'event', 'PDF Download', 'Working_with_attributes_letter');" target="_blank">Letter</a>
   ]</p>
